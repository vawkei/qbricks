...
“I don’t know what functions these libraries have or what kind of data they expect.”  
...
But TypeScript doesn’t know their types by default.

Without @types/node, you’ll see errors like:
```bash
...
# Git ignore:
created a .gitignore file in the root directory, along with frontend folder and backend folder. added the usual stuff there that i wanted to ignore:
```bash
# Logs
logs
*.log
...
Then committed the project and lpushed to github.

# Introduced MongoDb:

created a .env file, in it, I put a string there for my mongodb connection. Then went to the index.tsx file and then wrote this code block there:
```js
...
of course this: process.env.MONGODB_URI, this is pointing at the .env file.
